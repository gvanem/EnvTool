...
/* The following bits are used to determine the regexp syntax we recognize.
 */
 ...
 * literals. If set, then \+ and \? are operators and + and ? are literals.
 */
...
/* This global variable (=0) defines the particular regexp syntax to use
 * (for some interfaces).  When a regexp is compiled, the syntax used is
...
#define RE_SYNTAX_EGREP  (RE_CHAR_CLASSES          | \
                          RE_CONTEXT_INDEP_ANCHORS | \
                          RE_CONTEXT_INDEP_OPS     | \
                          RE_HAT_LISTS_NOT_NEWLINE | \
                          RE_NEWLINE_ALT           | \
 ...
 */
#define _RE_SYNTAX_POSIX_COMMON (RE_CHAR_CLASSES | \
                                 RE_DOT_NEWLINE  | \
                                 RE_DOT_NOT_NULL | \
                                 RE_INTERVALS    | \
                                 RE_NO_EMPTY_RANGES)
...
#define RE_SYNTAX_POSIX_EXTENDED (_RE_SYNTAX_POSIX_COMMON  | \
                                  RE_CONTEXT_INDEP_ANCHORS | \
                                  RE_CONTEXT_INDEP_OPS     | \
                                  RE_NO_BK_BRACES          | \
                                  RE_NO_BK_PARENS          | \
 ...
 */
#define RE_SYNTAX_POSIX_MINIMAL_EXTENDED  (_RE_SYNTAX_POSIX_COMMON  | \
                                           RE_CONTEXT_INDEP_ANCHORS | \
